...
public abstract class AbstractCommitLogReplayer implements CommitLogReadHandler
{
    @VisibleForTesting
    ...
    private static final Logger logger = LoggerFactory.getLogger(AbstractCommitLogReplayer.class);
    ...
    protected final CommitLogPosition globalPosition;
    ...
    public AbstractCommitLogReplayer(ICommitLog commitLog)
    {
        ...
        for (ColumnFamilyStore cfs : ColumnFamilyStore.all())
        {
            ...
            if (truncatedAt != null)
            {
                ...
                long restoreTime = commitLog.getArchiver() == null ? Long.MAX_VALUE : commitLog.getArchiver().restorePointInTime;
        ...
        this.archiver = commitLog.getArchiver();
    }
    ...
    public abstract AbstractCommitLogReader getCommitLogReader();
    ...
    {
        for (Map.Entry<TableId, AtomicInteger> entry : getCommitLogReader().getInvalidMutations())
    ...
    public static class MutationInitiator
    {
        protected Future<Integer> initiateMutation(final Mutation mutation,
                                                   ...
                                                   final AbstractCommitLogReplayer commitLogReplayer)
        {
